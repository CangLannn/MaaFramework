...
public:
    ...
    bool debug_trace_info() const { return debug_trace_info_; }
...
private:
    ...
    bool set_debug_trace_info(MaaOptionValue value, MaaOptionValueSize val_size);
